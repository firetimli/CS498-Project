...
class PostedJobs extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = { showModal: false, selectedJobIndex: null, jobsData:[{"title":"Software Engineer", "endDate":"May 10 2019", "location":"San Francisco", "description": ["Experience working with a large codebase on a cross functional team", "Strong knowledge of SQL, Bachelor’s degree in Computer Science, computer engineering, electrical engineering OR equivalent work experience"], "starredNumber":10, "starredResumes":[{"JS_name":"Alex", "JS_resumeLink": "https://www.w3schools.com/images/w3schools_green.jpg", "location":"Los Angeles"}, {"JS_name":"Mary", "JS_resumeLink": "https://s3-us-west-2.amazonaws.com/s.cdpn.io/29841/dog.jpg", "location":"Chicago"}, {"JS_name":"Mary", "JS_resumeLink": "http://portfolio.charleskdesigns.com/wp-content/uploads/2019/04/001.jpg", "location":"Boston"}]},
